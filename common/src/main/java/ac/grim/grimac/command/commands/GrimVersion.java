...
public class GrimVersion implements BuildableCommand {
    ...
    public static void checkForUpdatesAsync(Sender sender) {
        ...
        sender.sendMessage(Component.text()
                .append(Component.text("Olympia Version: ").color(NamedTextColor.GOLD))
                .append(Component.text(current).color(NamedTextColor.GOLD))
                .build());
        ...
        try {
            ...
            if (statusCode < 200 || statusCode >= 300) {
                ...
                sender.sendMessage(Objects.requireNonNullElseGet(msg, () -> Component.text()
                        ...
                        .append(Component.text(" Failed to check latest OlympiaAC version. Update server responded with status code: ")
            ...
            Component msg = switch (status) {
                case AHEAD ->
                        Component.text("You are using a development version of OlympiaAC").color(NamedTextColor.LIGHT_PURPLE);
                case UPDATED ->
                        Component.text("You are using the latest version of OlympiaAC").color(NamedTextColor.GREEN);
                case OUTDATED -> Component.text()
                        .append(Component.text("New OlympiaAC version found!").color(NamedTextColor.GOLD))
                        ...
                        .build();
                case UNKNOWN ->
                        Component.text("You are using an unknown OlympiaAC version.").color(NamedTextColor.RED);
            };
            ...
            LogUtil.error("Failed to check latest OlympiaAC version.", e);
        }
    }
