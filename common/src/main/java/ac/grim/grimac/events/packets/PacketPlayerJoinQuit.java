...
public class PacketPlayerJoinQuit extends PacketListenerAbstract {
    ...
    public void onUserLogin(UserLoginEvent event) {
        ...
        Object nativePlayerObject = Objects.requireNonNull(event.getPlayer(), "nativePlayerObject");
        ...
        applyToggle(platformPlayer, toggles, PlayerToggleStore.KEY_ALERTS,
                "olympia.alerts", "olympia.alerts.enable-on-join", "olympia.alerts.enable-on-join.silent",
        ...
        applyToggle(platformPlayer, toggles, PlayerToggleStore.KEY_VERBOSE,
                "olympia.verbose", "olympia.verbose.enable-on-join", "olympia.verbose.enable-on-join.silent",
        ...
        applyToggle(platformPlayer, toggles, PlayerToggleStore.KEY_BRANDS,
                "olympia.brand", "olympia.brand.enable-on-join", "olympia.brand.enable-on-join.silent",
        ...
        if (platformPlayer.hasPermission("olympia.spectate") && GrimAPI.INSTANCE.getConfigManager().getConfig().getBooleanElse("spectators.hide-regardless", false)) {
